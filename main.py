...
def trade_vale_valbz(id):
    ...
    if(buy1 - sell2 >= 20 and buy1 - sell2 < 100):
        write(exchange, {"type": "add", "order_id": id, "symbol":
              "VALBZ", "dir": "BUY", "price": sell2+2, "size": 1})
        write(
            exchange, {"type": "add", "order_id": id + 1, "symbol": "VALE", "dir": "SELL", "price": buy1-2, "size": 1})
        write(
            exchange, {"type": "convert", "order_id": id + 2, "symbol": "VALE", "dir": "BUY", "size": 1})
    elif(buy2 - sell1 >= 20 and buy2 - sell1 < 100):
        write(
            exchange, {"type": "add", "order_id": id, "symbol": "VALBZ", "dir": "SELL", "price": buy2-2, "size": 1})
        write(
            exchange, {"type": "add", "order_id": id + 1, "symbol": "VALE", "dir": "BUY", "price": sell1+2, "size": 1})
        write(
